...
class Send:
    ...
    def authentication(self, login, password):
        ...
        url = f'http://127.0.0.1:5000//Server/authentication/{login}'
        passwd = {"password": password}
        response = requests.post(url, headers=passwd)
        return response.json()
    ...
    def write(self, user_id, word, translate):
        """создание карточки"""
        url = f'http://127.0.0.1:5000//Server/create_card/{user_id}'
        data = {word: translate}
    ...
    def update(self, user_id, word, new_word, translate):
        """Изменение карточки"""
        url = f'http://127.0.0.1:5000//Server/update_card/{user_id}'
    ...
    def get_card(self, user_id, word):
        """Получение карточки"""
        url = f'http://127.0.0.1:5000//Server/receive_card/{user_id}'
        data = {word:''}
        response = requests.post(url,json=data)
        print(response.json())
    ...
    def get_all_cards(self, user_id):
        ...
        url = f'http://127.0.0.1:5000//Server/receive_all_cards/{user_id}'
    ...
    def delete_card(self, user_id, card_name):
        """Удаление карточки"""
        url = f'http://127.0.0.1:5000//Server/delete_card/{user_id}'
        data = {card_name: ''}
        response = requests.post(url, json=data)
        print(response.json())
    ...
    def create_deck(self, user_id, deck_name):
        """Создание колоды"""
        url = f'http://127.0.0.1:5000//Server/create_deck/{user_id}'
        data = {deck_name: ''}
        response = requests.post(url, json=data)
        print(response.json())
    ...
    def get_deck(self, user_id, deck):
        """Получение колоды"""
        url = f'http://127.0.0.1:5000//Server/receive_deck/{user_id}'
        data = {deck:''}
        response = requests.post(url,json=data)
        print(response.json())
    ...
    def get_all_decks(self, user_id):
        ...
        url = f'http://127.0.0.1:5000//Server/receive_all_decks/{user_id}'
        response = requests.post(url)
        print(response.json())
    ...
    def add_card_to_deck(self, user_id, deck_name, card_name):
        ...
        url = f'http://127.0.0.1:5000//Server/add_card_to_deck/{user_id}'
    ...
    def rename_deck(self, user_id, deck_name, new_deck_name):
        ...
        url = f'http://127.0.0.1:5000//Server/rename_deck/{user_id}'
    ...
    def delete_deck(self,user_id, deck_name):
        """Удаление колоды"""
        url = f'http://127.0.0.1:5000//Server/delete_deck/{user_id}'
        data = {deck_name:''}
        response = requests.post(url, json=data)
        print(response.json())
